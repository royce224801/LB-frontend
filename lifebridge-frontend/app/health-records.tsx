...
const createStyles = (colors: any) => StyleSheet.create({
    ...
    bmiResult: { marginTop: -5, marginBottom: 20, fontSize: 16, fontWeight: '600', textAlign: 'center', color: colors.primary },
    saveButton: { backgroundColor: colors.primary, paddingVertical: 18, borderRadius: 12, alignItems: 'center', marginTop: 10 },
    saveButtonText: { color: colors.textInverse, fontSize: 16, fontWeight: 'bold' },
});