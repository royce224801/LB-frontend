...
export default function HomeScreen() {
  ...
  const RiskCard = () => {
    ...
    const statusColor = riskStatus?.color || colors.textMuted;
  ...
  const isMedicineAdmin = userId === MEDICINE_ADMIN_ID;
  const isAnyAdmin = isUserAdmin || isMedicineAdmin;
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.menuScrollContent} showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push('/order-medicines' as any)}
          >
            <MaterialCommunityIcons name="medical-bag" size={30} color="#FF6B35" />
            <View style={styles.menuItemTextContainer}>
              <Text style={styles.menuItemText}>Order Medicines</Text>
              <Text style={styles.menuItemSubtext}>Order medicines with home delivery</Text>
            </View>
          ...
          >
            <Ionicons name="location-outline" size={30} color="#34C759" />
            <View style={styles.menuItemTextContainer}>
              <Text style={styles.menuItemText}>Track Orders</Text>
              <Text style={styles.menuItemSubtext}>Track your medicine orders</Text>
            </View>
          ...
          {isMedicineAdmin && (
            ...
            >
              <Ionicons name="receipt-outline" size={30} color="#FF9500" />
              <View style={styles.menuItemTextContainer}>
                <Text style={styles.menuItemText}>Manage Orders</Text>
                <Text style={styles.menuItemSubtext}>Update delivery status</Text>
              </View>
          ...
          {isMedicineAdmin && (
            <TouchableOpacity
              style={styles.menuItem}
              onPress={() => router.push('/shop-management' as any)}
            >
              <Ionicons name="storefront-outline" size={30} color="#007AFF" />
              <View style={styles.menuItemTextContainer}>
                <Text style={styles.menuItemText}>Shop Management</Text>
                <Text style={styles.menuItemSubtext}>Manage medicine inventory</Text>
              </View>
          ...
          {isMedicineAdmin && (
            <TouchableOpacity
              ...
              onPress={async () => {
                try {
                  const response = await fetch('http://10.0.2.2:8080/api/admin/initialize-data', {
                    method: 'POST',
                    headers: {
                  ...
                  if (response.ok) {
                    ...
                    alert('Error: Failed to initialize data');
                  }
                } catch (error) {
            ...
            >
              <Ionicons name="download-outline" size={30} color="#FF6B35" />
              <View style={styles.menuItemTextContainer}>
                <Text style={styles.menuItemText}>Initialize Sample Data</Text>
                <Text style={styles.menuItemSubtext}>Populate database with medicines</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#FF6B35" />
            </TouchableOpacity>
          )}
          ...
          >
            <Ionicons name="notifications-outline" size={30} color="#8E8E93" />
